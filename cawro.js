...
/* ----------------------------------------------------------------------------
/* http://www.pubnub.com/console?channel=genetic_cars_2&pub=demo&sub=demo
-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= */
...
multiplayer.player         = {};
multiplayer.player.channel = 'genetic_cars_2';
multiplayer.player.car_id  = multiplayer.uuid().slice(-5);
